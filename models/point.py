...
class PointRoot(ndb.Model):
    ...
    pointsSupportedByMe = ndb.KeyProperty(repeated=True, indexed=False, kind='PointRoot')
    supportedArchiveForDelete = ndb.KeyProperty(repeated=True, indexed=False, kind='PointRoot')
    pointsCounteredByMe = ndb.KeyProperty(repeated=True, indexed=False, kind='PointRoot')
    counteredArchiveForDelete = ndb.KeyProperty(repeated=True, indexed=False, kind='PointRoot')
